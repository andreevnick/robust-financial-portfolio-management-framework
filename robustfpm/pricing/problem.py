...
incapsulates a problem of pricing and hedging an option under a robust financial portfolio management framework
...
class ISolver(ABC):
    ...
    def solve(self, problem, calc_hedge=False, calc_precision=False):
        ...
        -------
        solution : dict
            a dictionary, representing the solution, where:
