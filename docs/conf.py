...
sys.path.insert(0, os.path.abspath('../robustfpm/'))
...
# configure sorting in autodoc
# the default is 'alphabetical'

autodoc_member_order = 'bysource' # to sort in the same order as members are listed in source code