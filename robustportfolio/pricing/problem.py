...
incapsulates a problem of pricing and hedging an option via a guaranteed deterministic approach
...
class ConvhullSolver(ISolver):
    """
    Represents the numeric solver to the option pricing problem under the robustportfolio approach.
    ...
    See also
    --------
    :class:`robustportfolio.pricing.option_pricer_RU.OptionPricer`
