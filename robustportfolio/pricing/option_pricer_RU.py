...
from robustportfolio.cxhull import get_max_coordinates, in_hull
...
class OptionPricer:
    '''
    Represents the numeric solver to the European option pricing problem under the robustportfolio approach.
    ...
    IOption
    ProfilerData
    :class:`robustportfolio.pricing.problem.ConvhullSolver`
