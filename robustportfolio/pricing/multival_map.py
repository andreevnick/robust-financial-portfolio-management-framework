...
See Also
--------
:class:`robustportfolio.pricing.set_handler.RealSpaceHandler`
:class:`robustportfolio.pricing.set_handler.NonNegativeSpaceHandler`
"""
...
class IMultivalMap(ABC):
    ...
    def dim(self):
        r"""
            int: The dimension of image or :code:`np.inf` if return value can be of any dimension (e.g., a :class:`robustportfolio.pricing.set_handler.RealSpaceHandler`)
...
class SimplexConstraints(IMultivalMap):
    ...
    :class:`robustportfolio.pricing.set_handler.NonNegativeSimplex`
    """
